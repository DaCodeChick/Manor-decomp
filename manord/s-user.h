...
{
	ServerUserRec *nextUser;   ///< Pointer to the next user in the linked list.
	ServerUserRec *prevUser;   ///< Pointer to the previous user in the linked list.
...
{
	ServerAuthUserRec *next; ///< Pointer to the next user in the linked list.
	char name[32];           ///< User's name.
